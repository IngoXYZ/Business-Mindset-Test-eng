      ...
      <div className="max-w-4xl mx-auto px-4 space-y-8">
          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mt-2">
                Hello {userSession.name}, here are your results
              </p>
            </div>
          </div>
        </div>
        ...
        <Card className="bg-green-50 border-green-200">
          <CardContent className="pt-6">
            <div className="flex items-center gap-3 text-green-800">
              ...
              <div>
                <h3 className="font-semibold">Results Sent by Email!</h3>
                <p className="text-sm text-green-700 mt-1">
                  Your test results have been automatically sent to us. 
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-gray-500">
            Would you like to take another test with a different name?
          </p>
        </div>
      </div>
    </div>
